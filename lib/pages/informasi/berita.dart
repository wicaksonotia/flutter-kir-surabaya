...
class _BeritaState extends State<Berita> {
  ...
  Widget build(BuildContext context) {
    return Obx(
      () => widget.beritaController.isLoadingAll.value
          ? Container(
          ...
          : GridView.builder(
              ...
              itemCount: widget.beritaController.resultDataAll.length,
              shrinkWrap: true,
              ...
              itemBuilder: (_, index) {
                var dataJudul =
                    widget.beritaController.resultDataAll[index].judul!;
                // var dataBerita =
                //     widget.beritaController.resultDataAll[index].berita!;
                var dataTanggal = DateTime.tryParse(
                    widget.beritaController.resultDataAll[index].tanggal!);
                // Uint8List decodePhoto;
                // if (widget.beritaController.resultDataAll[index].gambar != null) {
                //   decodePhoto = const Base64Decoder().convert(
                //       widget.beritaController.resultDataAll[index].gambar!);
                // }
